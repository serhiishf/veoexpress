...
import { GoogleTagManagerScripts } from '../GoogleTagManagerScripts/GoogleTagManagerScripts';
...
export const GoogleTagManager = () => {
  ...
  useEffect(() => {
    if (isGtagLoaded && !hasSetConsent) {
      ...
      const consent = getCookieConsentValue(trackingConfig.cookieBannerCookieName);
